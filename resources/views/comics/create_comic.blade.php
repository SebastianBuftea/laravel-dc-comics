                    ...
                    <form action="{{ route('comics.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control my-1"
                                placeholder="Enter the Title of the comic" value="{{ old('title') }}" required>
                        </div>
                        <div class="form-group">
